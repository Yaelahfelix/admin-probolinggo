...
import { getDataSatu } from "@/lib/actions/pengaduanAction"
    ...
    <Fragment>
      <main className="flex flex-col gap-5 justify-center content-center p-5">
        <Card className="w-full">
          <CardHeader>
            <CardTitle>Edit Pengaduan</CardTitle>
            <CardDescription>Edit Pengaduan</CardDescription>
          </CardHeader>
          <CardContent className="py-0">
            <DataForm pengaduan={data.data} />
          </CardContent>

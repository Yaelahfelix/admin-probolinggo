...
import { getDataSatu } from "@/lib/actions/petugasAction"
    ...
    <Fragment>
      <main className="flex flex-col gap-5 justify-center content-center p-5">
        <Card className="w-full">
          <CardHeader>
            <CardTitle>Edit Petugas</CardTitle>
            <CardDescription>Edit Petugas</CardDescription>
          </CardHeader>
          <CardContent className="py-0">
            <DataForm petugas={data.data} />
          </CardContent>

...
import { createJenisAduan, editJenisAduan } from "@/lib/actions/jenis_aduan_action"
...
export default function JenisForm({ jenis }: { jenis?: any }) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    startTransition(async () => {
      ...
      const data = jenis
        ? await editJenisAduan(jenis.id, formData)
        : await createJenisAduan(formData)

...
import { getJenisAduanSatu } from "@/lib/actions/jenis_aduan_action"
...
export default async function edit({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  const data = await getJenisAduanSatu(id)
    ...
    <Fragment>
      <main className="flex flex-col gap-5 justify-center content-center p-5">
        <Card className="w-full">
          <CardHeader>
            <CardTitle>Edit Jenis Aduan</CardTitle>
            <CardDescription>Edit Jenis Aduan Form</CardDescription>
          </CardHeader>

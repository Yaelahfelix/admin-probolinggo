...
import { getDataSatu } from "@/lib/actions/jenis_penyelesaianAction"
    ...
    <Fragment>
      <main className="flex flex-col gap-5 justify-center content-center p-5">
        <Card className="w-full">
          <CardHeader>
            <CardTitle>Edit Jenis Penyelesaian</CardTitle>
            <CardDescription>Edit Jenis Penyelesaian</CardDescription>
          </CardHeader>
